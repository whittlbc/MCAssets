...
- (BOOL) browserViewController:(MCBrowserViewController*)picker shouldPresentNearbyPeer:(MCPeerID*)peerID withDiscoveryInfo:(NSDictionary*)info
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"foundUser" object:self userInfo:dict];
...
-(void)session:(MCSession *)session didReceiveData:(NSData *)data fromPeer:(MCPeerID *)peerID{
    ...
    [self didReceiveDataWithNotification:dict];
}
...
-(void)sendMyMessage:(NSString *)text {
    ...
    if (_chattingWithID != nil) {
        NSArray *peers = [[NSArray alloc] initWithObjects:_chattingWithID, nil];
...
-(void)didReceiveDataWithNotification:(NSDictionary *)dict{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"receiveMessage"
                                                        object:nil
                                                      userInfo:dict];
}
